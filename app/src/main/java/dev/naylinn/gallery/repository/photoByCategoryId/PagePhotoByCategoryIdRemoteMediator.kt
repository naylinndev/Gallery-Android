...
import dev.naylinn.gallery.common.TYPE_PHOTO_BY_CATEGORY
...
class PagePhotoByCategoryIdRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            ...
            val loadKey = when (loadType) {
                ...
                LoadType.APPEND -> {
                    ...
                    val remoteKey = appDatabase.withTransaction {
                        remoteKeyDao.getRemoteKeyByType(type = TYPE_PHOTO_BY_CATEGORY)
                    }
            ...
            val data = netApi.getPhotosByCategory(categoryId = categoryId, appSecret = APP_SECRET, page = loadKey)
            data
                .onSuccess { response ->
                    ...
                    appDatabase.withTransaction {
                        ...
                        if (loadType == LoadType.REFRESH) {
                            remoteKeyDao.deleteByType(type = TYPE_PHOTO_BY_CATEGORY)
                        }
                        remoteKeyDao.saveRemoteKey(
                            RemoteKeyEntity(
                                type = TYPE_PHOTO_BY_CATEGORY,
